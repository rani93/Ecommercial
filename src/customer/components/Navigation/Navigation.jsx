          ...
          >
            ...
            <TabGroup className="mt-2">
              ...
              <TabPanels as={Fragment} >
                {navigation.categories.map((category) => (
                  <TabPanel key={category.name} className="px-4 pt-10 pb-8 space-y-10">
              ...
              <PopoverGroup className="hidden lg:ml-8 lg:block lg:self-stretch">
                ...
                {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      ...
                      <PopoverPanel
                        transition
                        className="absolute z-10 inset-x-0 top-full text-sm text-gray-500 transition data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
                      >
